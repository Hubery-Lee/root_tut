...
TH1I * newTH1I(Char_t name[]="h1",Double_t binw=0.01, Double_t LowBin=0.0, Double_t HighBin=3.0,Bool_t MevTitle = kTRUE,Int_t iMode=-1){
...
TH1D * newTH1D(Char_t name[]="h1",Double_t binw=0.01, Double_t LowBin=0.0, Double_t HighBin=3.0,Bool_t MevTitle = kTRUE,Int_t iMode=-1){
  Int_t nbin = TMath::Nint( (HighBin - LowBin)/binw );
  HighBin = binw*nbin + LowBin;
...
TH2F * newTH2F(Char_t name[]="h2",TH1F *hx = 0,TH1F *hy = 0){
  if(hx == NULL){
...
TH2D * newTH2D(Char_t name[],Char_t title[],Double_t binwX,Double_t binLX,Double_t binHX,Double_t binwY,Double_t binLY,Double_t binHY){
...
void txt(Double_t x0=0.3, Double_t y0=0.3,Char_t txts[]="",Int_t iColor=2,Double_t fSize=0.06,Bool_t IsNDC=kTRUE){
...
void tag(Char_t txts[]="",Double_t x0=0.3, Double_t y0=0.3,Int_t iColor=38,Double_t fSize=0.08,Bool_t IsNDC=kTRUE,Double_t Angle=45){
  TLatex *ltx = new TLatex();
  ltx->SetNDC(IsNDC);
  if(!(x0>=0 && x0<=1 && y0>=0 && y0<=1) ) ltx->SetNDC(kFALSE);
  ltx->SetTextColor(iColor);
...
void txt(TH1F *h,Double_t x0=0.3, Double_t y0=0.3,Char_t txts[]="",Int_t iColor=2,Double_t fSize=0.05,Bool_t IsNDC=kTRUE){
...
void txtmax(TH1F *h,Char_t txts[]="",Int_t iColor=2,Double_t fSize=0.1){
...
void xtit(TH1 *h,Char_t title[]="",Double_t offset=1.0){
...
void txtRMS(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="RMS=%.2f",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtRMSE(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="RMS=%.2f#pm%.2f",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtRMSY(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="RMS=%.2f",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtM(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="Mean=%.2f",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtMY(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="#bar{y}=%.2f",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtMX(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="MeanX=%.2f",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtME(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="Mean=%.2f#pm%.2f",Double_t fsize=0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtMvsRMSE(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="Mean/RMS=%.2f#pm%.2f",Double_t fsize=0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void MakeLegend(TH1 * datahist,   // Histogram with data
		...
		double xhi,       // Right edge of legend 
		                  //(fraction of canavas width)
		double yhi,Char_t Option[] = "LEP"){       // Top edge of legend  
  //(fraction of canavas height)
...
void MakeLegend(TH1 * datahist,   // Histogram with data
		...
		Char_t Option[] = "LEP"){       // Top edge of legend  
  //(fraction of canavas height)
...
void txtR(Double_t x0, Double_t y0,TH1 *h,Char_t sName[]="RMS/M=%s",Double_t sizeTxt=0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtMErr(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="Mean=%s",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
...
void txtRMSErr(Double_t x0, Double_t y0,TH1 *h,Char_t sFormat[]="RMS=%s",Double_t fsize = 0.06){
  h->SetStats(kFALSE);
  TLatex *ltx = new TLatex();
  ltx->SetNDC(kTRUE);
  ltx->SetTextColor(h->GetLineColor());
